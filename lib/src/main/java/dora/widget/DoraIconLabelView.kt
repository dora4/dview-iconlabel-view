...
class DoraIconLabelView @JvmOverloads constructor(
    ...
    init {
        ...
        val drawable = a.getDrawable(
                R.styleable.DoraIconLabelView_dview_ilv_icon
        )
        ...
        text = a.getString(R.styleable.DoraIconLabelView_dview_ilv_text).toString()
        hoverColor = a.getColor(R.styleable.DoraIconLabelView_dview_ilv_hoverColor, Color.BLACK)
        iconLabelGap = a.getDimensionPixelSize(R.styleable.DoraIconLabelView_dview_ilv_iconLabelGap, TypedValue.applyDimension(
        ...
        labelTextColor = a.getColor(R.styleable.DoraIconLabelView_dview_ilv_textColor, textColors.defaultColor)
